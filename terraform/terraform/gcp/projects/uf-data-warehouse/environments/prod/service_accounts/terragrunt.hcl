...
inputs = {
  service_accounts = {
    ...
    hive-to-bq-sa = {
      account_id = "hive-to-bq-sa"
      display_name = "Hive to BigQuery Service Account" #Service account to move data from Uber's Hive tables to BigQuery dataset gold_digital_brokerage_prod
      generate_key = true
    }
  }
