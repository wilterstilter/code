module "role_datadog_viewer" {
  source  = "terraform-google-modules/iam/google//modules/custom_role_iam"
  version = "~> 7.7.1"

  target_level = "org"
  target_id    = var.organization_id
  role_id      = "datadogViewer"
  title        = "Datadog Viewer"
  description  = "Allows read only access to Datadog to be used for metric collection" # Combination of roles Monitoring Viewer, Compute Viewer, Cloud Asset Viewer, Browser
  permissions = [
