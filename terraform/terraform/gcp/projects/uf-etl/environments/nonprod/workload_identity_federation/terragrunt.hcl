...
inputs = {
  ...
  pool_id                    = "wif-nonprod"                                           # Name of WIF Pool Id
  pool_name                  = "wif-nonprod"                                           # The display name of the wif pool
  pool_description           = "nonprod WIF pool for authentication of composer CI/CD" # The description of the wif pool and what it is used for
  pool_disabled              = false                                                   # A boolean depicting whether the wif pool is disabled or not. Should always be false
  pool_provider_id           = "terraform-cloud-oidc-nonprod"                          # The unique identifier for the Workload Identity Pool Provider within the specified pool.
  pool_provider_display_name = "oidc_provider_for_nonprod"                             # A human-readable name for the Workload Identity Pool Provider.
