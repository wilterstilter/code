...
inputs = {
  ...
  service_account            = "cloud-composer-sa-d@uf-etl-d.iam.gserviceaccount.com"
  network_project_id         = "freight-network-host-d"                                                                     # Network project id
  network                    = "projects/freight-network-host-d/global/networks/dev"                                        # Network for the Composer environment 
  subnetwork                 = "projects/freight-network-host-d/regions/us-south1/subnetworks/us-south1-composer-network-d" # Subnetwork for the Composer environment
 ...
 scheduler = {
  ...
  storage_bucket         = "uf-etl-dev-composer"        # Storage bucket for the Composer environment
}
