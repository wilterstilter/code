...
inputs = {
  ...
  etl_service_account = "etl-sa-freight-data-p@${local.project_id}.iam.gserviceaccount.com"
  ...
  project_iam_bindings = {
    ...
    "roles/bigquery.jobUser" = {
      entities = [
        ...
        "serviceAccount:etl-sa-freight-data-p@${local.project_id}.iam.gserviceaccount.com",
        "serviceAccount:sa-hyper-create-engine@uf-data-analysis.iam.gserviceaccount.com",
        "serviceAccount:etl-sa-enterprise-analysts-p@${local.project_id}.iam.gserviceaccount.com",
        "serviceAccount:etl-sa-freight-data-science-p@${local.project_id}.iam.gserviceaccount.com",
        "serviceAccount:etl-sa-mx-p@${local.project_id}.iam.gserviceaccount.com",
        "serviceAccount:etl-sa-logistics-engineering-p@${local.project_id}.iam.gserviceaccount.com"
      ]
    },
    "roles/composer.worker" = {
      entities = [
        "serviceAccount:cloud-composer-sa-p@${local.project_id}.iam.gserviceaccount.com"
      ]
    },
