# GCP Global HTTPS Load Balancer for F5 Forwarding

This Terraform module provisions a Google Cloud Global External HTTPS Load Balancer designed to forward traffic to F5 BIG-IP backends. It provides a secure and reliable setup for exposing your F5-managed applications to the internet, with features like automatic SSL certificate management, modern TLS enforcement, and health checking.
...
- **URL Map**: The URL map routes all incoming requests to a single backend service that is configured to forward traffic to your F5 backends.
...
```hcl
module "glb_f5_forwarder" {
  source = "./path-to-this-module"

  domain          = "f5-forwarder.example.com"
