...
dependency "carrierdb-azure-prod" {
  config_path = "../../internet-neg/prod/carrierdb-azure-prod"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.carrierdb-azure-prod.outputs.neg_self_link: link]
  )
}
