...
dependency "fed-dal-f5" {
  config_path = "../../hybrid-neg/prod/fed-dal-f5"
}

dependency "fed-tp-dal-f5" {
  config_path = "../../hybrid-neg/prod/fed-tp-dal-f5"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.fed-tp-dal-f5.outputs.neg_self_link: link]
  )
}
