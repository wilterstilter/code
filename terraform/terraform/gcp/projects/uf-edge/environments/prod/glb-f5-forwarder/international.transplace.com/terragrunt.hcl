...
dependency "international-dal-f5" {
  config_path = "../../hybrid-neg/prod/international-dal-f5"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.international-dal-f5.outputs.neg_self_link: link]
  )
}
