...
dependency "uatcustomswmsapi-aus-f5" {
  config_path = "../../hybrid-neg/uat/uatcustomswmsapi-aus-f5"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.uatcustomswmsapi-aus-f5.outputs.neg_self_link: link]
  )
}
