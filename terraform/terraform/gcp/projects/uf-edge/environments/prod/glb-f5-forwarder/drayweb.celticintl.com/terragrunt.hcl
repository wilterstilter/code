...
dependency "celtic-dray-web-dal-f5" {
  config_path = "../../hybrid-neg/prod/celtic-dray-web-dal-f5"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.celtic-dray-web-dal-f5.outputs.neg_self_link: link]
  )
}
