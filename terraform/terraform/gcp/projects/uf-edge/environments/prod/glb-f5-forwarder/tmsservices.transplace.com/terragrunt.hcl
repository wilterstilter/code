...
dependency "tmsservices-dal-prod-f5" {
  config_path = "../../hybrid-neg/prod/tmsservices-dal-prod-f5"
}
...
inputs = {
  ...
  default_backend_timeout_sec = 120
  min_tls_version = "TLS_1_2"
  default_service = concat(
    [for zone, link in dependency.tmsservices-dal-prod-f5.outputs.neg_self_link: link]
  )
}
