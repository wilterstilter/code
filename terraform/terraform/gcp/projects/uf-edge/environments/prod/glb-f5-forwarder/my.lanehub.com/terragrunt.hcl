...
dependency "lanehub-azure-prod" {
  config_path = "../../internet-neg/prod/lanehub-azure-prod"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.lanehub-azure-prod.outputs.neg_self_link: link]
  )
}
