...
dependency "laser-azure-prod" {
  config_path = "../../internet-neg/prod/laser-azure-prod"
}
...
inputs = {
  domains = [
    ...
    "laser.tplaser.com.mx"
  ]
  security_policy_self_link = dependency.cloud_armor.outputs.security_policy_self_link
  min_tls_version = "TLS_1_2"
  default_service = concat(
    [for zone, link in dependency.laser-azure-prod.outputs.neg_self_link: link]
  )
  redirect_map = {
    "laser.transplace.com" = "laser.tplaser.com.mx"
  }
}
