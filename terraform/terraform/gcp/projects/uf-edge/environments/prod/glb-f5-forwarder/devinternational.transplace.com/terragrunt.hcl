...
dependency "devinternational-aus-f5" {
  config_path = "../../hybrid-neg/uat/devinternational-aus-f5"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.devinternational-aus-f5.outputs.neg_self_link: link]
  )
}
