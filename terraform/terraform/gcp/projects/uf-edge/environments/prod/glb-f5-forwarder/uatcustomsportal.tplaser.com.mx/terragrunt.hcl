...
dependency "uatcustomsportal-aus-f5" {
  config_path = "../../hybrid-neg/uat/uatcustomsportal-aus-f5"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.uatcustomsportal-aus-f5.outputs.neg_self_link: link]
  )
}
