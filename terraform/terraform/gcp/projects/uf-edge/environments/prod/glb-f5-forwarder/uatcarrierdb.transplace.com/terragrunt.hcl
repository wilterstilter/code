...
dependency "uatcarrierdb-azure-np" {
  config_path = "../../internet-neg/uat/uatcarrierdb-azure-np"
}
...
inputs = {
  ...
  default_service = concat(
    [for zone, link in dependency.uatcarrierdb-azure-np.outputs.neg_self_link: link]
  )
}
