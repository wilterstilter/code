...
dependency "celchi-aus-f5" {
  config_path = "../../hybrid-neg/uat/celchi-aus-f5"
}
...
inputs = {
  ...
  additional_hostnames = [
    "*.celtic-uat.celticintl.com",
  ]
  default_service = concat(
    [for zone, link in dependency.celchi-aus-f5.outputs.neg_self_link: link]
  )
}
